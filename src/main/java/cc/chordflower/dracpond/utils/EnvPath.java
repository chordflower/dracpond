...
public interface EnvPath {
  ...
  enum EnvPaths implements EnvPath {
    ...
    private EnvPaths( Path userDataPath, Path userConfigPath, Path userCachePath, Path userLogPath, Path systemDataPath, Path systemConfigPath, Path systemCachePath, Path systemLogPath ) {
